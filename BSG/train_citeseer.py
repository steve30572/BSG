...
def train_nodeclas(model, data, args, device='cpu'):
    ...
    if np.mean(results) >= 0.735:
        f = open(f'./result_citeseer.txt', 'a')
        ...
        f.close()
        # torch.save(embedding, f'{np.mean(results):.2%}_citeseer.pt')
...
parser.add_argument("--layer", nargs="?", default="gcn", help="GNN layer, (default: gcn)")
parser.add_argument("--encoder_activation", nargs="?", default="elu", help="Activation function for GNN encoder, (default: elu)")
parser.add_argument('--encoder_channels', type=int, default=random.choice([256, 512, 64, 128]), help='Channels of GNN encoder layers. (default: 128)')
parser.add_argument('--hidden_channels', type=int, default=random.choice([256, 512, 64, 128]), help='Channels of hidden representation. (default: 64)')
parser.add_argument('--decoder_channels', type=int, default=random.choice([256, 32, 64, 128]), help='Channels of decoder layers. (default: 128)')
parser.add_argument('--encoder_layers', type=int, default=2, help='Number of layers for encoder. (default: 2)')
parser.add_argument('--decoder_layers', type=int, default=2, help='Number of layers for decoders. (default: 2)')
parser.add_argument('--encoder_dropout', type=float, default=0.8)#random.choice([0.4, 0.5, 0.6, 0.7, 0.8, 0.9]), help='Dropout probability of encoder. (default: 0.8)')
parser.add_argument('--decoder_dropout', type=float, default=0.2, help='Dropout probability of decoder. (default: 0.2)')
parser.add_argument('--alpha', type=float, default=random.choice([0.00001, 0.0001, 1e-6]), help='loss weight for degree prediction. (default: 0.)')
...
parser.add_argument('--lr', type=float, default=random.choice([0.01]), help='Learning rate for training. (default: 0.01)')
...
parser.add_argument('--bn', action='store_true', help='Whether to use batch normalization for GNN encoder. (default: False)')
parser.add_argument('--l2_normalize', action='store_true', help='Whether to use l2 normalize output embedding. (default: False)')
parser.add_argument('--nodeclas_weight_decay', type=float, default=random.choice([1e-3]), help='weight_decay for node classification training. (default: 1e-3)')
...
parser.add_argument('--beta', type=float, default=round(random.uniform(0., 0.0001), 5))
