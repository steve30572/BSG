...
parser.add_argument("--layer", nargs="?", default="gcn", help="GNN layer, (default: gcn)")
parser.add_argument("--encoder_activation", nargs="?", default="elu", help="Activation function for GNN encoder, (default: elu)")
parser.add_argument('--encoder_channels', type=int, default=random.choice([256, 512, 1024, 128, 64]), help='Channels of GNN encoder layers. (default: 128)') #, 2048, 4096,
parser.add_argument('--hidden_channels', type=int, default=random.choice([256, 512, 1024,  32, 64, 128]), help='Channels of hidden representation. (default: 64)') #2048,
parser.add_argument('--decoder_channels', type=int, default=random.choice([256, 512, 1024, 64, 128]), help='Channels of decoder layers. (default: 128)')
parser.add_argument('--encoder_layers', type=int, default=2, help='Number of layers for encoder. (default: 2)')
parser.add_argument('--decoder_layers', type=int, default=2, help='Number of layers for decoders. (default: 2)')
parser.add_argument('--encoder_dropout', type=float, default=random.choice([ 0.7, 0.8, 0.9]), help='Dropout probability of encoder. (default: 0.8)')
parser.add_argument('--decoder_dropout', type=float, default=0.2, help='Dropout probability of decoder. (default: 0.2)')
parser.add_argument('--alpha', type=float, default=random.choice([0.001, 0.0001, 0.00001, 0.000001]), help='loss weight for degree prediction. (default: 0.)')

parser.add_argument('--lr', type=float, default=random.choice([0.01]), help='Learning rate for training. (default: 0.01)')
parser.add_argument('--weight_decay', type=float, default=random.choice([1e-5, 5e-4, 5e-5]), help='weight_decay for link prediction training. (default: 5e-5)')
parser.add_argument('--grad_norm', type=float, default=1.0, help='grad_norm for training. (default: 1.0.)')
parser.add_argument('--batch_size', type=int, default=2**16, help='Number of batch size for link prediction training. (default: 2**16)')
...
parser.add_argument("--device", type=int, default=0)
parser.add_argument('--full_data', action='store_true', help='Whether to use full data for pretraining. (default: False)')
# parser.add_argument('--beta', type=float, default=round(random.uniform(0., 0.002), 4))
...
# parser.add_argument('--gamma', type=float, default=round(random.uniform(0., 1), 4))
